      ...
      {showSearchCnt && (
        <>
          ...
          <div className='navsearch'>
            <div className='navsearch-left'></div>
            <div className='navsearch-center'>
              <div className="navbar-container-searchmain">
                <div className='navbar-container-search-demo navsearchtrue'>
                <div className='navbar-container-search-demo-icon ncsdemoicon'>
                  <IoSearchSharp />
                </div>
                <input
                  autoFocus={true}
            ...
            <div className='navsearch-right'></div>
          </div>
        </>
      )}
    </>
